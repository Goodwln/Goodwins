 ...
 */
UCLASS()
class HOMEWORK_API ASpiderPawn : public AGameCodeBasePawn
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "SpiderBot")
	class USkeletalMeshComponent* SkeletalMeshComponent;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SpiderBot | IK Settings")
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "SpiderBot | IK Settings", meta = (ClampMin = 0.0f, UIMin = 0.0f))
	float IKTraceExtendDistance = 30.f;

	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "SpiderBot | IK Settings", meta = (ClampMin = 0.0f, UIMin = 0.0f))
